...
const API_KEY = "trnsl.1.1.20200427T141024Z.76527e5ee1a0c664.75f4ea4cac82a37949b4da59c61115fd7888651c";
...
let myFunc = function(wordx,langsx){
    ...
    method = "GET",
    url = `https://translate.yandex.net/api/v1.5/tr.json/translate?key=${API_KEY}&text=${wordx}&lang=${langsx}`;
